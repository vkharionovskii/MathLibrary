...
START_TEST(s21_ceil_f) {
    ...
    for (double i = -100.0; i < 100.0; i += 0.1) {
        ck_assert_uint_eq(s21_ceil(i), ceil(i));
    }
}
END_TEST
...
START_TEST(s21_floor_f) {
    ...
    for (double i = -100.0; i < 100; i += 0.01) {
        ck_assert_uint_eq(s21_floor(i), floor(i));
    }
}
END_TEST
...
START_TEST(s21_fmod_f) {
    ...
    ck_assert_int_eq(s21_fmod(23.456, 0), fmod(23.456, 0));
}
END_TEST
...
START_TEST(s21_pow_f) {
    ...
    ck_assert_int_eq(s21_pow(3.0, 14.15926), pow(3.0, 14.15926));
    ...
    ck_assert_int_eq(s21_pow(-1234, -4.3), pow(-1234, -4.3));
    ck_assert_int_eq(s21_pow(1234, -4.3), pow(1234, -4.3));
    ck_assert_int_eq(s21_pow(2.0, 2.0), pow(2.0, 2.0));
    double expp = -30.0;
    for (double x = -100.0; x < 100.0; x += 0.5) {
        ck_assert_int_eq(s21_pow(x, expp), pow(x, expp));
        expp += 0.7;
    }
}
END_TEST
